...
$stmt = mysqli_prepare($koneksi, "INSERT INTO assignments (course_id, judul_tugas, deskripsi, file_path, deadline) VALUES (?, ?, ?, ?, ?)");
mysqli_stmt_bind_param($stmt, "issss", $courseId, $judul, $deskripsi, $filePath, $deadline);
